...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex h-screen bg-[#F5F6FA] font-sans text-ink-900">
      {/* Sidebar */}
      <div className="w-72 bg-ink-900 text-white flex flex-col shrink-0">
        <div className="h-20 flex items-center gap-3 px-6 border-b border-white/10">
          <LakehouseMark />
          <div>
            <h1 className="text-base font-bold tracking-tight leading-none">Lakehouse</h1>
            <p className="text-[11px] text-ink-300 font-data mt-1">Data Console</p>
          </div>
        </div>
