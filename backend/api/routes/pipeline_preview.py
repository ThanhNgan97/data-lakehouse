...
GOLD_TABLES = {
    ...
    # === [MỚI] Thêm 2 bảng Data Marts từ nguồn API trường cung cấp ===
    "kpi_api_teaching_summary": "Tổng hợp Tiến độ giảng dạy (API)",
    "kpi_api_learning_summary": "Tổng hợp Kết quả học tập (API)",
}
